...
run("./mmul", output_csv, raw_output_csv)
run("./nbody", output_csv, raw_output_csv)
run("./qap chr15c.dat", output_csv, raw_output_csv)
run("./delannoy 13", output_csv, raw_output_csv)

"""
run("./npb_bt_w", output_csv, raw_output_csv)
run("./ssca 15", output_csv, raw_output_csv)
"""
